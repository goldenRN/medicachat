...
def build_openai_input(
    ...
    developer_message = {
        ...
        "content": (
            ...
            "Prefer a neat assistant-style layout instead of a dense paragraph. "
            "For informative answers, use a short intro sentence and then structured sections or bullets. "
            "When the answer contains multiple points, format them with line breaks, bullet points, or numbered lists so it is easy to read. "
            "For addresses, contact details, schedules, branches, or location information, present them as clearly separated labeled bullets. "
            "Use Markdown lightly when helpful, such as **bold labels** and bullet lists. "
